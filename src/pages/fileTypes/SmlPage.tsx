      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">SML Files</h1>
              <p className="text-muted-foreground">Learn how to submit Standard ML assignments</p>
            </div>
          </div>
        </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                How to Submit SML Files
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Standard ML files (.sml) are supported for functional programming assignments. 
                Here's everything you need to know about submitting SML projects:
              </p>
              
              <div className="space-y-3">
                <h4 className="font-semibold">Supported File Types:</h4>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary">.sml</Badge>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  <li>Single .sml file upload</li>
                  <li>Multiple SML files with signatures</li>
                  <li>SML projects as ZIP archive</li>
                  <li>ML Basis (.mlb) project files</li>
                </ul>
              </div>
            </CardContent>
          </Card>
                  ...
                  <div className="space-y-2 p-4 rounded-lg border hover:bg-muted/50 transition-colors cursor-pointer">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Function evaluation results and outputs</p>
                      </div>
                    </div>
                  </div>
                </Link>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2 text-muted-foreground">
                <li>• Use proper SML naming conventions and style guidelines</li>
                <li>• Include type annotations for complex functions</li>
                <li>• Prefer pattern matching over conditional expressions</li>
                <li>• Use local declarations to avoid namespace pollution</li>
                <li>• Write helper functions to break down complex problems</li>
                <li>• Test your functions with edge cases and empty lists</li>
              </ul>
            </CardContent>
          </Card>
        </div>
