...
const repos = [
  ...
  { name: "Autolab Autograders Examples - Cpp Interactive Autograder Template", url: "https://github.com/autolab/autograders-examples/tree/main/Cpp-InteractiveAutograderTemplate" },
];
